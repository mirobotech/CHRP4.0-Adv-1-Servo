/*==============================================================================
 Library: servo.c                       Activity: mirobo.tech/chrp4-advanced-1
 Date: May 24, 2023
 
 CHRP4 demonstration servo library including functions to configure individual
 H1 - H4 header pins for servo output as well as to produce a servo pulse on a
...
// Enable output on the selected SERVO1 - SERVO4 (H1 - H4) header pin. Call
...
// Create a single servo pulse on the specified SERVO1 - SERVO4 output, with 
...
void servo_pulse(unsigned char servo, unsigned char position)
{
    ...
    LATB = LATB & ~servo;       // End servo pulse by clearing servo output pin
}
